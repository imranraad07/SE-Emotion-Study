...
with open(path + '_anger.txt') as csv_file:
...
with open(path + '_sad.txt') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter='\t')
    next(csv_reader)
    idx = 0
    for row in csv_reader:
...
with open(path + '_fear.txt') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter='\t')
    next(csv_reader)
    idx = 0
    for row in csv_reader:
...
with open(path + '_love.txt') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter='\t')
    next(csv_reader)
    idx = 0
    for row in csv_reader:
...
with open(path + '_joy.txt') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter='\t')
    next(csv_reader)
    idx = 0
    for row in csv_reader:
...
with open(path + '_surprise.txt') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter='\t')
    next(csv_reader)
    idx = 0
    for row in csv_reader:
